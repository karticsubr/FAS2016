...
%%% the title and author information, and above the body of the content.
 ...
 \teaser{
   ...
   \caption{Modern renderers implicitly map high-dimensional sampling patterns into light paths along which virtual measurements are contributed to the image plane. Then, they perform a numerical integration over paths to estimate radiance on the image plane. The final image is reconstructed on a regular pixel-grid from the estimates. The focus of this course is on errors arising from numerical integration.}
   \label{fig:renderhl}
 }
