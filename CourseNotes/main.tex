...
Graduate students and professionals seeking to understand Monte Carlo rendering, Fourier analysis and/or errors due to sampling.

\section*{Prerequisites}
Undergraduate level proficiency in probability theory and calculus.

\section*{Level of difficulty}
Moderate. We will begin by reviewing much of the intuition required for the appreciation of an intricate combination of Monte Carlo rendering, Fourier analysis, sampling theory and probability, which is the focus of this course.
\clearpage
...
\href{<k.subr@hw.ac.uk>}{\texttt{<k.subr@hw.ac.uk>}} \hfill
...
Dartmouth College\\
\href{mailto:wojciech.k.jarosz@dartmouth.edu}{\texttt{<wojciech.k.jarosz@dartmouth.edu>}} \hfill
...
Dartmouth College\\
\href{mailto:gurprit.singh@dartmouth.edu}{\texttt{<gurprit.singh@dartmouth.edu>}} \hfill
