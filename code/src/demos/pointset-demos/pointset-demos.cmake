...
file(GLOB HEADERS
  ...
  src/test-functions/*.h
  src/distributions/*.h
)

function(make_exec exec_name)
        add_executable(${BIN_PATH}/${exec_name} ${SOURCES} ${HEADERS} ./src/demos/pointset-demos/${exec_name}.cxx)
...
make_exec(pointset-demo1)
#make_exec(pointset-importance-halfspace-analytic-demo1)
